...
process.TFileService=cms.Service("TFileService",
        fileName=cms.string("ntuple_susy_output.root"),
...
'root://eoscms.cern.ch//store/mc/RunIISpring15MiniAODv2/WZTo3LNu_TuneCUETP8M1_13TeV-powheg-pythia8/MINIAODSIM/74X_mcRun2_asymptotic_v2-v1/50000/023437BD-2D7A-E511-9189-A0369F7FC5BC.root'
 )
)
...
process.susyana = cms.EDAnalyzer('SUSYAnalyserBSM',
...
#### commented ####  process.ApplyBaselineHBHENoiseFilter *  # filter based on HBHENoiseFilter decisions
